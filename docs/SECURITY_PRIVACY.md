...
租金補貼申請條件預檢同樣不得呼叫OpenAI：只接受縣市、enum／boolean自我確認、所得是否低於畫面門檻及月租等最小typed input。第一版不得要求姓名、身分證字號、戶籍／所得／財產／權狀或弱勢證明；response使用`private, no-store`，Client不得保存答案或自行重算狀態。
